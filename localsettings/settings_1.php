...
$rules['max_ini_fan_factor']    	= 2;        // Default is 3.
...
$rules['randomskillrolls'] = 0; 	//Automated Random Skill Rolls
// Toggle Manual Entry of Random Skill Rolls: 0 = enabled. 1 = disabled.
$rules['randomskillmanualentry'] = 1; 	//Manual Random Skill Rolls
...
$rules['base_inducements'] = 0; 	//Base Inducements Only
