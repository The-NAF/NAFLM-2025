...
function print_prow($p, $x, $y, $h, $bgcolor='#FFFFFF', $bordercolor='#000000', $linewidth=1, $fontsize, $ma_color, $st_color, $ag_color, $pa_color, $av_color) {
  ...
  $this->Cell(80, $h, $p['name'], 1, 0, 'L', true, '');
  $this->Cell(80, $h, $p['pos'], 1, 0, 'L', true, ''); 
  $this->Cell(84, $h, $p['keyw'], 1, 0, 'L', true, '');
  $this->SetFillColorBB($this->hex2cmyk($ma_color));
  $this->Cell(17, $h, $p['ma'], 1, 0, 'C', true, '');
  $this->SetFillColorBB($this->hex2cmyk($st_color));
  $this->Cell(17, $h, $p['st'], 1, 0, 'C', true, '');
  $this->SetFillColorBB($this->hex2cmyk($ag_color));
  $this->Cell(17, $h, boolval($p['ag']) ? $p['ag']."+" : "", 1, 0, 'C', true, '');
  $this->SetFillColorBB($this->hex2cmyk($pa_color));
  $this->Cell(17, $h, ($p['pa']>0 && $p['pa']<7) ? $p['pa']."+" : (($p['st']==0) ? "" : "-"), 1, 0, 'C', true, '');
  $this->SetFillColorBB($this->hex2cmyk($av_color));
  $this->Cell(17, $h, boolval($p['av']) ? $p['av']."+" : "", 1, 0, 'C', true, '');
  $this->SetFillColorBB($this->hex2cmyk($bgcolor));
  $this->SetXY(($x+17+80+80+84+17+17+17+17+17),$y);
  // Need to change to MultiCell to fit Skills and Injuries text if too long
  if ($newfontsize<$fontsize) {
    $this->SetFontSize($newfontsize);
    $this->MultiCell(245, $newheight, $p['skills'], 1, 'L', true);
    $this->SetFontSize($fontsize);
  }
  else 
    $this->MultiCell(245, $h, $p['skills'], 1, 'L', true);
  $this->SetXY($x+17+80+80+84+17+17+17+17+17+245,$y);
  ...
  $this->Cell(36, $h, $p['value'], 1, 1, 'R', true, '');
...
function print_srow($p, $x, $y, $h, $bgcolor='#FFFFFF', $bordercolor='#000000', $linewidth=1, $fontsize) {
  ...
  //Print cells in order
  $this->Cell(105, $h, $p['name'], 0, 0, 'L', true, '');
  $this->Cell(65, $h, $p['keyw'], 0, 0, 'L', true, '');
