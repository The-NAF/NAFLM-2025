...
#                )";
#                # m$i = minus/negative $i months from present month.
#                array_push($queries, "SUM(IF($range, IF(inj = ".MNG.",  1, 0)+IF(agn = ".MNG.",  1, 0), 0)) AS 'mng_m$i'");
#                array_push($queries, "SUM(IF($range, IF(inj = ".NI.",   1, 0)+IF(agn = ".NI.",   1, 0), 0)) AS 'ni_m$i'");
#                array_push($queries, "SUM(IF($range, IF(inj = ".MA.",   1, 0)+IF(agn = ".MA.",   1, 0), 0)) AS 'ma_m$i'");
#                array_push($queries, "SUM(IF($range, IF(inj = ".AV.",   1, 0)+IF(agn = ".AV.",   1, 0), 0)) AS 'av_m$i'");
#                array_push($queries, "SUM(IF($range, IF(inj = ".AG.",   1, 0)+IF(agn = ".AG.",   1, 0), 0)) AS 'ag_m$i'");
#                array_push($queries, "SUM(IF($range, IF(inj = ".ST.",   1, 0)+IF(agn = ".ST.",   1, 0), 0)) AS 'st_m$i'");
#                array_push($queries, "SUM(IF($range, IF(inj = ".DEAD.", 1, 0)+IF(agn = ".DEAD.", 1, 0), 0)) AS 'dead_m$i'");
#                array_push($queries, "YEAR(SUBDATE(DATE(NOW()), INTERVAL $i MONTH)) AS 'yr_m$i'");
#                array_push($queries, "MONTH(SUBDATE(DATE(NOW()), INTERVAL $i MONTH)) AS 'mn_m$i'");
#            }
