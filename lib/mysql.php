...
$core_tables = array(
    ...
    'players' => array(
        ...
        'is_captain' => 'TINYINT SIGNED DEFAULT 0',
    ...
    'match_data' => array(
        ...
        'hat'          	=> 'TINYINT UNSIGNED',
        'agn'          	=> 'TINYINT UNSIGNED',
	...
	'player_keywords' => array(
        'keyword_id'   => $CT_cols['keyword_id'].' NOT NULL PRIMARY KEY',
        'name'      => $CT_cols['name'],
        'cat' => 'VARCHAR(1)',
	),
);
...
function setup_database() {
    ...
    Message::create(array(
        ...
        'title'      => 'NAFLM 2025 installed!',
        'msg'        => 'Congratulations! You have successfully installed the NAFLM 2025 League Manager. See "About" for more information. Ensure you change the root account password immediately.'));
    // Done!
    mysql_close($conn);
    return true;
}
...
function upgrade_database($version, $opts, $upgradeSQLs) {
    ...
    switch ($version) {
        case '2020':
            ...
            global $DEA, $stars, $skillarray; # Make global so that below include(s) will overwrite their values.
            require('lib/game_data_bb2025.php'); # Load BB2020 data.
