...
class Translations 
{
	...
	***************************/
	...
	/***************************
	   Translate player keywords
	***************************/
	public function TranslatePlayerKeywords() {		
	    global $playerkeywordsididx;
	    foreach($playerkeywordsididx as &$pleyerkeyword) {
		    $pleyerkeyword = $this->getTrn('playerkeywords/'.strtolower(str_replace(array(' ','-','&',"'",'/'),'',$pleyerkeyword)));
	    }
	    unset($pleyerkeyword);
	}
}