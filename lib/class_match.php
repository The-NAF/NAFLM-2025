...
$T_PMD_ACH       = array('mvp','cp','td','intcpt','bh','si','ki','misc',);
$T_PMD_IR        = array('ir1_d1','ir1_d2','ir2_d1','ir2_d2','ir3_d1','ir3_d2',);
$T_PMD_INJ       = array('inj','agn',);
$T_PMD_HAT       = array('hat',);
$T_PMD_OTHER     = array('mg',);
$T_PMD           = array_merge($T_PMD_RELS, $T_PMD_ACH, $T_PMD_IR, $T_PMD_INJ, $T_PMD_HAT, $T_PMD_OTHER);
$T_PMD__ENTRY_EXPECTED = array_merge($T_PMD_ACH, $T_PMD_IR, $T_PMD_INJ, $T_PMD_HAT); # These fields should be passed to _entry().
...
// These are the values allowed in the $T_PMD_HAT fields.
$T_HATS = array(
	99 => 'NONE',
	0  => 'Animal',
	1  => 'Beastman',
...
class Match
{
    ...
    public function getPlayerEntry($pid) {
         ...
         **/
        global $T_PMD_ACH, $T_PMD_IR, $T_PMD_INJ, $T_PMD_HAT;
        $T_PMD_ACH_IR = array_merge($T_PMD_ACH, $T_PMD_IR);
        $fields = array_merge(array_fill_keys($T_PMD_ACH_IR, 0), array_fill_keys($T_PMD_INJ, NONE), array_fill_keys($T_PMD_HAT, 0));
            ...
            case ($pid <= ID_STARS_BEGIN || $pid == ID_MERCS): # Star player or Mercenary?
                ...
                switch ($pid) 
                {
                    ...
                    case ID_MERCS: # Mercenary?
                        ...
                        $input['hat'] = NONE;
                        $input['agn'] = $input['skills']; unset($input['skills']);
                        break;
                }
                break;
        }
